...
## Purpose
    ...
    It implements a selection logic (detailed in "How to configure"),
...
## Configuration
    Open the file "congig.json" (in this folder),
    and set the fields to your desired values:
        ...
        storage: the kind of storage API you'd like to work with. 
            string
            Please note: Even though there is a level of abstraction to this element of the project,
            some functions in the current internal implementation still rely specifically on MongoDB API.
        ...
        logAllErrors: 
            ...
            every container (regardless of the selection filter).
                Aware of the fact that this is a problematic limatation, 
                and that a fixed version would include the option to log stderr per selected containers.
...
## Run
    ...
    node index.js // after a moment, you'll see the following output: 
    ...
    Please note:
        ...
        However, creating new images while the program is running, is not supported,
        so please be sure to have the required images already built before running DockerLogger.
...
## What would I improve given more time:
    ...
    Improve:
        ...
        Enhance selection logic:
            ...
            considering a logic that attaches containers as a factor of the frequency of their usage,
        ...
        Shorten some functions
            Currently there are some super long functions here (e.g, logContainer).

        Learn about the way to implement deeper, more automated and more informative tests.
